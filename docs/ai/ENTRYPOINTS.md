...
| Chat 신고·차단·삭제·room ban·계정 제재·미디어 격리/evidence | `tasks/chat-ugc-safety-room-moderation/decisions.md` → `phase-7-implementation-plan.md` → `contracts/chat-moderation-v1.json` → ADR-024 → `CHAT.md`/`FIREBASE.md`/`TESTS.md` → task plan/progress/QA |
